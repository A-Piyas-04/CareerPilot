...
|--------------|--------------|
| Live Deployment — App is accessible at a public URL (Vercel, Railway, Render, etc.). Must be stable and functional during judging. | Live URL reachable; core features work on hosted version |
